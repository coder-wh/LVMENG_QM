...
public class CodeTable {
	...
	static {
		...
		proPattern.put(148, new Pattern(3, "A、服务态度需要改善"));
		proPattern.put(149, new Pattern(3, "B、解决问题能力有限"));
		proPattern.put(150, new Pattern(3, "C、响应及时性待加强"));
		
		proPattern.put(136, new Pattern(4, "A、解决方案能力不足"));
		proPattern.put(137, new Pattern(4, "B、实施的产品了解程度不够"));
		proPattern.put(138, new Pattern(4, "C、专业技能不足"));
		proPattern.put(142, new Pattern(4, "A、解决方案能力不足"));
		proPattern.put(143, new Pattern(4, "B、交付验收文档不够清晰"));
		proPattern.put(144, new Pattern(4, "C、专业技能不足"));
		
		proPattern.put(156, new Pattern(5, "C、不如同类厂商表现好"));
		
		proPattern.put(158, new Pattern(6, "D、不会推荐"));
		
		proPattern.put(130, new Pattern(7, 6)); //C1 您对整个项目实施过程的满意程度评价是?
		
		proPattern.put(132, new Pattern(8, 6));	//C2 您给绿盟科技技术人员的表现打几分?
		
		proPattern.put(134, new Pattern(9, 6));	//CF1 您对项目整体服务过程的满意程度评价是?
		
		proPattern.put(117, new Pattern(10, 6));	//B2.2.2 您给合作伙伴技术人员的表现打几分?
		
		proPattern.put(112, new Pattern(11, Pattern_Type.ALL));	//B1.1_1 (文本框题结果) 请您简单描述不如其他厂商表现好的原因,我们可以怎么做?
		proPattern.put(114, new Pattern(11, Pattern_Type.ALL));	//B2.1_1 (文本框题结果) 请您简单描述以上给出低分的原因,我们可以怎么改善?
		proPattern.put(116, new Pattern(11, Pattern_Type.ALL));	//B2.2.1_1 (文本框题结果) 请您简单描述以上给出低分的原因,我们可以怎么改善?
		proPattern.put(118, new Pattern(11, Pattern_Type.ALL));	//B2.2.2.1_1 (文本框题结果) 请您简单描述以上给出低分的原因,我们可以怎么改善?
		proPattern.put(125, new Pattern(11, Pattern_Type.ALL));	//B3.1_1 (文本框题结果) 选择“其他”,那么您认为我们在服务方面需要改进的是?
		proPattern.put(131, new Pattern(11, Pattern_Type.ALL));	//C1.1_1 (文本框题结果) 请您简单描述以上给出低分的原因,我们可以怎么改善?
		proPattern.put(133, new Pattern(11, Pattern_Type.ALL));	//C2.1_1 (文本框题结果) 请您简单描述以上给出低分的原因,我们可以怎么改善?
		proPattern.put(135, new Pattern(11, Pattern_Type.ALL));	//CF1.1_1 (文本框题结果) 请您简单描述以上给出低分的原因,我们可以怎么改善?
		proPattern.put(141, new Pattern(11, Pattern_Type.ALL));	//C3.1_1 (文本框题结果) 选择“其他”,那么您认为我们在专业能力方面需要改进的是?
		proPattern.put(147, new Pattern(11, Pattern_Type.ALL));	//CF3.1_1 (文本框题结果) 选择“其他”,那么您认为我们在专业能力方面需要改进的是?
		proPattern.put(153, new Pattern(11, Pattern_Type.ALL));	//C4.1_1 (文本框题结果) 选择“其他”,那么您认为我们在专业能力方面需要改进的是?
		proPattern.put(155, new Pattern(11, Pattern_Type.ALL));	//A1.1_1 (文本框题结果) 请您简单描述以上给出低分的原因,我们可以怎么改善?
		proPattern.put(157, new Pattern(11, Pattern_Type.ALL));	//A2.1_1 (文本框题结果) 请您简单描述不如其他厂商表现好的原因,我们可以怎么做?
		proPattern.put(178, new Pattern(11, Pattern_Type.ALL));	//Q86_1 (文本框题结果) 您还有什么意见建议吗?您的建议会使我们不断完善,以便为您提供更好的支撑。
		proPattern.put(109, new Pattern(11, Pattern_Type.ALL));	//D_1 (文本框题结果) 选择“其他”,那么您认为我们在产品方面需要改进的是?
		...
		salePattern.put(156, new Pattern(3, "C、不如同类厂商表现好"));
		
		salePattern.put(158, new Pattern(4, "D、不会推荐"));
		
		salePattern.put(115, new Pattern(5, 6));	//B2.2 您给合作伙伴销售人员的表现打几分?
		
		salePattern.put(117, new Pattern(6, 6));	//B2.2.2 您给合作伙伴技术人员的表现打几分?
		
		salePattern.put(119, new Pattern(7, "A、服务态度需要改善"));
		salePattern.put(120, new Pattern(7, "B、解决问题能力有限"));
